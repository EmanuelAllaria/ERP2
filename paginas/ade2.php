            ...
            <div class="row">
              ...
              if (isset($_GET['d'])) {
                  ...
                  if (isset($_GET['v']) && $_GET['v'] !== '') {
                      $vendedor = ' and adelantos.quien_ad = ' . $_GET['v'];
                  } else {
                      $vendedor = '';
                  }
              ...
              <div class="col-md-2"><small class="form-control-feedback"> Vendedor </small><br>
                <select class="form-control" id="vendedorsel">
                  ...
                  <?php
                  $busca_vende = $link->query("SELECT CONCAT(nombre,', ',apellido) as nombre, id FROM `usuarios` WHERE `estado_usuarios` LIKE '1' order by nombre asc, apellido ASC");
              ...
              <div class="col-md-2" style="align-self: center;">
                <?php if (isset($_GET['d']) || isset($_GET['h'])) { ?><a href="index.php?pagina=ade2">Quitar Filtros</a><?php } ?>
                ...
                <tbody>
                  ...
                  $con_adelanto = $link->query("
                                        SELECT * FROM `adelantos`
                                            left join usuarios on usuarios.id = adelantos.quien_ad
                  ...
                  ?>
                    <tr>
                                        ...
                                        <td class="font-weight-normal"><span class="footable-toggle"></span><?php echo $row['monto_adelanto']?></td>
  ...
  <script>
    ...
    function filtrar_vende() {
      ...
      if (datodesde) { // require a URL
        window.location = 'index.php?pagina=ade2&d=' + datodesde + '&h=' + datohasta + '&v=' + datovendedor; // redirect
      }
      return false;
    };
  </script>
