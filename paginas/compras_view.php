                        ...
                        <table style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>$<?=number_format($row2['iva'], 2, ',', '.')?></td>
                                    <td>$<?=number_format($row2['iibb'], 2, ',', '.')?></td>
                                    <td>$<?=number_format($row2['per_iva'], 2, ',', '.')?></td>
                                    <td>$<?=number_format($row2['imp_interno'], 2, ',', '.')?></td>
                                    <td>$<?=number_format($row2['tasa'], 2, ',', '.')?></td>
                                    <td>$<?=number_format($rowid['total_compra'], 2, ',', '.')?></td>
                                </tr>
                            </tbody>
                        </table>
                        <table style="width: 100%;">
                            <thead>
                                ...
                                <tr>
                                    <td>$<?=number_format($rowid['redondeo'], 2, ',', '.')?></td> 
                                </tr>
                            </thead>
                        </table>
                        <hr>
