      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6 m-b-20">
              <input placeholder="Utilidad" type="number" id="utilidad" class="form-control utilidad" disabled>
            </div>
            <div class="col-md-4 m-b-20">
...
/*          $("#utilidad").val(data.data.utilidad)*/
          ...
          if (data.data.foto != '' && data.data.foto != 'undefined') {
            $('#imgprod').attr('src', 'img/prod/' + data.data.foto);
          } else {
