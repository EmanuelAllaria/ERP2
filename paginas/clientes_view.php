...
?>
<div class="container-fluid" id="contenedor_total">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-xlg-12 col-md-9">
             <a style="margin-bottom: 10px;" class="btn btn-success" data-toggle="modal" href="#miModal" role="button">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="miModalLabel">Exportar a Excel</h5>
                  ...
                  <div class="modal-body">
                    ...
                    ¿Que fechas desea exporta a Excel?
                  </div>
                  <div class="col-md-12">
                        <small class="form-control-feedback"> Desde </small>
                        <input class="form-control filtro" type="date" id="d" name="d">
                    </div>
                    <div class="col-md-12">
                        <small class="form-control-feedback"> Hasta </small>
                        <input class="form-control filtro" type="date" id="h" name="h">
                        <input class="form-control filtro" type="number" id="c" name="c" hidden value="<?=$id?>">
                    </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <a href="#" class="btn btn-success" id="exportButton">Exportar</a>
                  </div>
                </div>
              </div>
            </div>
...
<script>
  document.getElementById('exportButton').addEventListener('click', function() {
    ...
    if (desde && hasta) {
      window.location.href = 'paginas/exportar_excel.php?desde=' + desde + '&hasta=' + hasta+ '&cliente=' + cliente;
    } else {
